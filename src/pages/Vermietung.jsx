...
import { FaIceCream, FaTruck, FaWhatsapp, FaEnvelope, FaCheck, FaTimes, FaStar, FaArrowRight } from 'react-icons/fa'

function PreisBox({ preis, einheit, klein }) {
  return (
    <div className="inline-flex flex-col items-center bg-gradient-to-br from-gold via-gold-light to-gold text-braun-900 rounded-2xl px-6 py-4 shadow-[0_8px_32px_rgba(201,168,108,0.45)] border border-gold-light/40">
      {klein && (
        <span className="font-sans text-[10px] tracking-[0.2em] uppercase font-semibold mb-1 opacity-70">
          {klein}
        </span>
      )}
...
function InklusiveListe({ items, exkl }) {
  return (
...
export default function Vermietung() {
  ...
  const waLink = `https://wa.me/436645336243?text=${waText}`
    ...
    <div className="pt-16 sm:pt-20">
      ...
      <section className="bg-braun-900 py-16 sm:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Vollservice-Paket: Eismaschine + Micha */}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2">
              ...
              <div className="bg-braun-800/60 backdrop-blur-sm p-7 sm:p-10 lg:p-12 flex flex-col justify-center">
                ...
                <h2 className="text-3xl sm:text-4xl font-display text-creme mb-2 leading-tight">
                  Eismaschine<br />
                  <span className="text-gold">+ Micha</span>
                </h2>
                <p className="text-braun-300 text-sm mb-7 leading-relaxed">
                  Sie bekommen alles aus einer Hand: die Soft-Eis-Maschine, das Material und
                  Micha — Ihren charmanten Eisverkäufer, der Ihre Gäste begeistert.
                </p>

                <div className="mb-8">
                  <PreisBox preis="500" einheit="6 Std. · inkl. MwSt." klein="pro Einsatz" />
                </div>
                ...
                <div className="mb-8 space-y-1.5">
                  ...
                  <InklusiveListe
                    ...
                    exkl={['Trinkgeld für den exklusiven Eisverkäufer']}
                  />
                </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8">
            ...
            <div className="rounded-2xl border border-braun-700 bg-braun-800/40 p-7 sm:p-8 flex flex-col">
              <div className="flex items-center gap-2 mb-4">
                <FaIceCream className="text-gold/70" size={13} />
                <span className="font-sans text-gold/80 text-xs tracking-[0.18em] uppercase font-semibold">Nur Maschine</span>
              </div>
              <h3 className="text-2xl sm:text-3xl font-display text-creme mb-3">
                Eismaschine<br />
                <span className="text-braun-400 text-xl">ohne Verkäufer</span>
              </h3>
            ...
            <div className="rounded-2xl border border-braun-700 bg-braun-800/40 p-7 sm:p-8 flex flex-col relative overflow-hidden">
              ...
              <h3 className="text-2xl sm:text-3xl font-display text-creme mb-3">
                Kühlwagen<br />
                <span className="text-braun-400 text-xl">zur Miete</span>
              </h3>
