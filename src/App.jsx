...
export default function App() {
  // Reichweitenmessung läuft zentral über den vis·à·vision-Beacon (functions/_middleware.js).
  // Der frühere eigene /api/track-Ping + die /stats-Seite wurden 15.06.2026 abgelöst.
  return (
    <>
