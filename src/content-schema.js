  ...
  events: {
    ...
    items: [
      ...
      },
      {
        ...
        text: 'La dolce vita am Bleiburger Wiesenmarkt! Euch erwarten frisch zubereitete Pizza vom Teigkeller, Wein, Spritzer, Aperol uvm., italienische Musik und beste Stimmung — mit DJ Hannes von Laut & Leise Events. Solange der Vorrat reicht!',
        datum: 'Montag, 7. September · ab 17:00 Uhr',
        bild: '/images/italo-night-2026-plakat.jpg',
        ort: 'Bleiburger Wiesenmarkt',
        istPlakat: true,
      },
      {
        titel: 'ANIMA — Ausstellung in Črna na Koroškem',
        text: 'Unsere Dauerausstellung ist auf Reisen: Die Werke von Michael Pietrowski — Porträts, Fadenbilder und Kohlepulver-Arbeiten — sind derzeit in der Ausstellung „ANIMA – Portreti in vrhovi“ im Kulturzentrum Črna na Koroškem (Slowenien) zu sehen.',
        datum: 'derzeit zu sehen',
        bild: '/images/pietrowski-ausstellung.webp',
        ort: 'Kulturzentrum Črna na Koroškem (SLO)',
